...
public class UserManage {
    ...
    public void createMember() {
        ...
        Map<?, ?> result = CommonUtils.jsonToObject(Map.class, WeiXinAPIUtil.createMember(access_token, member));
        assertEquals((String) result.get("errmsg"), ((Integer) result.get("errcode")).intValue(), 0);
    }
    ...
    public void updateMember() {
        ...
        depts.add(dept);
        member.setDepartment(depts);
        Map<?, ?> result = CommonUtils.jsonToObject(Map.class, WeiXinAPIUtil.updateMember(access_token, member));
        assertEquals((String) result.get("errmsg"), ((Integer) result.get("errcode")).intValue(), 0);
    }
    ...
    public void listSimpleMember() {
        String jsonString = WeiXinAPIUtil.simpleListMember(access_token, 2, 1, 0);
        UserRES m = CommonUtils.jsonToObject(UserRES.class, jsonString);
        assertEquals("++++++++++++++++++", m.getUserlist().size(), 3);
    ...
    public void batchDeleteMember() {
        ...
        String jsonString = WeiXinAPIUtil.batchDeleteMember(access_token, useridlist);
        Map<?, ?> result = CommonUtils.jsonToObject(Map.class, jsonString);
        assertEquals((String) result.get("errmsg"), ((Integer) result.get("errcode")).intValue(), 0);
    }
}
