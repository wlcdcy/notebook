...
public class WeixinResource {
    ...
    public String hello() {
        return String.format("this is [%s] service", WeixinResource.class.getName());
    }
    ...
    @GET
    @Produces(MediaType.TEXT_PLAIN)
    public String addressBook(@QueryParam("msg_signature") String msg_signature,
    ...
    public String addressBook_post(@QueryParam("msg_signature") String msgSignature,
            @QueryParam("timestamp") String timeStamp, @QueryParam("nonce") String nonce,
        ...
        try {
            ...
            if (!WeixinConfig.getInstance().isMessageReplySync()) {
                ...
                // TODO 同步模式回复
                WeixinMessage wxm = CommonUtils.xml2Object(sMsg, WeixinMessage.class);
                ...
                if (StringUtils.equals(wxm.getMsgType(), "text")) {
                    ...
                    replyMsg = String.format(replyMsg, wxm.getFromUserName(), wxm.getToUserName(), wxm.getCreateTime(),
                            textContent);
