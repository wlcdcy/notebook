...
public class WeiXinAPIUtil {
    ...
    public static String getAccessToken() {
        String req_url = String.format("https://qyapi.weixin.qq.com/cgi-bin/gettoken?corpid=%s&corpsecret=%s",
                WeixinResource.appCorpID, WeixinResource.appEncodingAESKey);
        CloseableHttpClient hc = NETUtils.getHttpClient(req_url.indexOf("https") == 0 ? true : false);
     ...
     */
    public static String sendMessage(String access_token, String msg) throws WeixinAPIEx {
        String req_url = String.format("https://qyapi.weixin.qq.com/cgi-bin/message/send?access_token=%s",
                access_token);
        ...
        try {
            try {
                ...
                e1.printStackTrace();
                throw new WeixinAPIEx("send message exception [" + e1.toString() + "]");
            }
            if (response.getStatusLine().getStatusCode() == 200) {
                try {
    ...
    public static String listDept(String access_token, String pid) {
        String url = String.format("https://qyapi.weixin.qq.com/cgi-bin/department/list?access_token=%s", access_token);
    ...
    public static String createDept(String access_token, Department dept) {
        String url = String.format("https://qyapi.weixin.qq.com/cgi-bin/department/create?access_token=%s",
                access_token);
    ...
    public static String updateDept(String access_token, Department dept) {
        String url = String.format("https://qyapi.weixin.qq.com/cgi-bin/department/update?access_token=%s",
                access_token);
        String jsonString = CommonUtils.object2Json(dept);
        return NETUtils.httpPostWithJson(url, jsonString);
    }
    ...
    public static String deleteDept(String access_token, String id) {
        String url = String.format("https://qyapi.weixin.qq.com/cgi-bin/department/delete?access_token=%s&id=%s",
                access_token, id);
        return NETUtils.httpGet(url);
    }
    ...
    public static String createMember(String access_token, User member) {
        String url = String.format("https://qyapi.weixin.qq.com/cgi-bin/user/create?access_token=%s", access_token);
    ...
    public static String updateMember(String access_token, User member) {
        String url = String.format("https://qyapi.weixin.qq.com/cgi-bin/user/update?access_token=%s", access_token);
        String jsonString = CommonUtils.object2Json(member);
        return NETUtils.httpPostWithJson(url, jsonString);
    }
    ...
    public static String deleteMember(String access_token, String userid) {
        String url = String.format("https://qyapi.weixin.qq.com/cgi-bin/user/delete?access_token=%s&userid=%s",
                access_token, userid);
        return NETUtils.httpGet(url);
    }
     ...
     * @return
     */
    public static String batchDeleteMember(String access_token, List<String> useridlist) {
        String url = String.format("https://qyapi.weixin.qq.com/cgi-bin/user/batchDelete?access_token=%s",
                access_token);
     ...
     * @return
     */
    public static String simpleListMember(String access_token, int deptid, int fetch_child, int status) {
        String url = String.format(
                "https://qyapi.weixin.qq.com/cgi-bin/user/simplelist?access_token=%s&department_id=%s&fetch_child=%s&status=%s",
     ...
     * @return
     */
    public static String listMember(String access_token, int deptid, int fetch_child, int status) {
        String url = String.format(
                "https://qyapi.weixin.qq.com/cgi-bin/user/list?access_token=%s&department_id=%s&fetch_child=%s&status=%s",
                access_token, deptid, fetch_child, status);
        return NETUtils.httpGet(url);
    }
    ...
    public static String inviteMember(String access_token, String userid) {
        ...
        String url = String.format("https://qyapi.weixin.qq.com/cgi-bin/invite/send?access_token=%s", access_token);
     ...
     * @return
     */
    public static String batchInviteMember(String access_token, InviteUser inviteUser) {
        String url = String.format("https://qyapi.weixin.qq.com/cgi-bin/batch/inviteuser?access_token=%s",
                access_token);
     ...
     * @return
     */
    public static <T> T mediaGet(String access_token, String media_id, Class<T> clazz) {
    ...
    public static String materialUpload(String access_token, Material material) {
        String url = String.format("https://qyapi.weixin.qq.com/cgi-bin/material/add_mpnews?access_token=%s",
                access_token);
     ...
     * @return
     */
    public static String materialUpload4Other(String access_token, String type, int agentid, File file) {
        String url = String.format(
                "https://qyapi.weixin.qq.com/cgi-bin/material/add_material?agentid=%s&type=%s&access_token=%s", agentid,
                type, access_token);
        Map<String, Object> params = new HashMap<String, Object>();
        params.put(file.getName(), file);
        return NETUtils.httpPostWithMultipart(url, params);
     ...
     * @return
     */
    public static <T> T materialGet(String access_token, String media_id, int agentid) {
        String url = String.format(
                "https://qyapi.weixin.qq.com/cgi-bin/material/get?access_token=%s&media_id=%s&agentid=%s", access_token,
                media_id, agentid);
     ...
     * @return
     */
    public static InputStream materialGet4OtherByStream(String access_token, String media_id, int agentid) {
        String url = String.format(
                "https://qyapi.weixin.qq.com/cgi-bin/material/get?access_token=%s&media_id=%s&agentid=%s", access_token,
                media_id, agentid);
     ...
     *            保存位置
     */
    public static void materialDown4Other(String access_token, String media_id, int agentid, String dist) {
        String url = String.format(
                "https://qyapi.weixin.qq.com/cgi-bin/material/get?access_token=%s&media_id=%s&agentid=%s", access_token,
                media_id, agentid);
        ...
        try {
            if (response.getStatusLine().getStatusCode() < 300) {
                ...
                NameValuePair nvp = response.getFirstHeader("Content-disposition").getElements()[0].getParameters()[0];
                InputStream is = null;
     ...
     * @return
     */
    public static String materialDelete(String access_token, String media_id, int agentid) {
        String url = String.format(
                "https://qyapi.weixin.qq.com/cgi-bin/material/del?access_token=%s&agentid=%s&media_id=%s", access_token,
                agentid, media_id);
        return NETUtils.httpGet(url);
    }
    ...
    public static String materialUpdate(String access_token, Material material) {
        String url = String.format("https://qyapi.weixin.qq.com/cgi-bin/material/update_mpnews?access_token=%s",
                access_token);
        String jsonString = CommonUtils.object2Json(material);
        return NETUtils.httpPostWithJson(url, jsonString);
    }
    ...
    public static String materialCount(String access_token, int agentid) {
        String url = String.format("https://qyapi.weixin.qq.com/cgi-bin/material/get_count?access_token=%s&agentid=%s",
    ...
    public static String materialList(String access_token, MaterialQuery param) {
        String url = String.format("https://qyapi.weixin.qq.com/cgi-bin/material/batchget?access_token=%s",
                access_token);
    ...
    public static String AgentGet(String access_token, int agentid) {
        String url = String.format("https://qyapi.weixin.qq.com/cgi-bin/agent/get?access_token=%s&agentid=%s",
                access_token, agentid);
        return NETUtils.httpGet(url);
    }
    ...
    public static String AgentSet(String access_token, Agent agent) {
        String url = String.format("https://qyapi.weixin.qq.com/cgi-bin/agent/set?access_token=%s", access_token);
    ...
    public static String AgentList(String access_token) {
        String url = String.format("https://qyapi.weixin.qq.com/cgi-bin/agent/list?access_token=%s", access_token);
        return NETUtils.httpGet(url);
    }
    ...
    public static void main(String[] args) {
        ...
        DeparmentRES obj = CommonUtils.jsonToObject(DeparmentRES.class, deptsJson);
