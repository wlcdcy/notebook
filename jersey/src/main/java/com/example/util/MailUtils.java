...
public class MailUtils {
    ...
    private static final String EMAIL = "wangyq@16feng.com";
    private static final String PASSWORD = "123qaz";
    ...
    public static void send(String subject, String content) {
        ...
        try {
            ...
            msg.setSender(new InternetAddress(EMAIL, "hello"));
     ...
     *            发件人
     */
    public static void proxySend(String subject, String content, String from, String to, String sender) {
        ...
        try {
            ...
            if (!SMTPReply.isPositiveCompletion(client.getReplyCode())) {
                client.disconnect();
                LOG.info("SMTP server refused connection.");
                return;
            }
    ...
    public void sendMailWithDKIM() {
        ...
        /*
         * dkimSigner = new DKIMSigner(<signingDomain>,<selector>,
         * <privateKey>); Message msg = new SMTPDKIMMessage(session,
         * dkimSigner); fill the message here transport.sendMessage(msg,
    ...
    public static void main(String[] args) {
        proxySend("pig", "pig，the world is too large", "wangyq@hiwork.com", "wlcdcy@163.com", "wangyq@16feng.com");
    }
