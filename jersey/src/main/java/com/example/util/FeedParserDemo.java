            ...
            FeedParserListener listener = new DefaultFeedParserListener() {
                ...
                public void onChannel(FeedParserState state, String title, String link, String description)
                    ...
                    if (state.current.getChild("pubDate") != null)
                        System.out.println(
                                "Found a new channel publish datetime:" + state.current.getChild("pubDate").getValue());
                }
                ...
                public void onItem(FeedParserState state, String title, String link, String description,
                    ...
                    System.out.println(String.format("Found a new published article:[%s]:[%s][%s] [%s]", title,
                            description, permalink, link));
                }
                ...
                public void onImage(FeedParserState state, String title, String link, String url)
                        throws FeedParserException {
    ...
    public static void useRome(String rss) {
        try {
            ...
            if (sf.getPublishedDate() != null) {
                System.out.println(
                        "publish date: " + DateFormatUtils.format(sf.getPublishedDate(), "yyyy-MM-dd hh:mm:ss"));
            }
