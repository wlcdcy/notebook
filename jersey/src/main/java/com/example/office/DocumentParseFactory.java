...
public class DocumentParseFactory {
	...
	public DocumentParse getDocumentParse(DocumentType  type){
		switch(type.getValue()){
			case 1: return getDOCXDecumentParse();
			case 2: return getDOCDecumentParase();
			case 3: return getXLSXDecumentParase();
			case 4: return getXLSDecumentParase();
			case 5: return getPDFDecumentParase();
			case 6: return getTEXTDecumentParase();
		}
		return null;
	}
