...
public class TeambitionUtils<T> {
	...
	public static void main(String[] args) {
		...
		while (it.hasNext()) {
			...
			// updateWebhook4Project(_id,_hook_id, hook_project,
			// project_events);
	...
	public static String access_token = "CQ-0Hyd0aJTys7xYeXX86EKQHsE=VH8Z1Ud21630f50f852de71389ba30f5ff2a22e5dfb4d834156f1b837c3ba5b021d631cfcdb679a880c0a09d4e481019befdf2e1a86091e5648c80b4dbc870850421058d59c187feaf5fd3ef70a269ca1226ea88bd652501cc14f742c347a92c55d2e961313deb08bc1a1b5c1cbf8222a05fb372";// "VH8Z1Ud21630f50f852de71389ba30f5ff2a22e5dfb4d834156f1b837c3ba5b021d631cfcdb679a880c0a09d4e481019befdf2e1a86091e5648c80b4dbc870850421058d59c187feaf5fd3ef70a269ca1226ea88bd652501cc14f742c347a92c55d2e961313deb08bc1a1b5c1cbf8222a05fb372";//
																																																																												// "xFNntgtIi4SPt1VeqSdxTD6MOWA=mK5_dJD130223d6334a2adee18b35aeb769823caf41bed623735052dc0274f7352347506b76ebedf45ceefddaf99b6ef33a33472a23ea71152e57c6d0a6e0e06b18670597e1eaf786983f8c0899e879536732d2935b82c541fb155e2aee64536774b76b01ebfec434159e9126d5f3fa1fbac165f";
	...
	public static String getOAuthUrl(String redirect_uri) {
		...
		String param = String.format("client_id=%s&state=%s&redirect_uri=%s",
				client_key, req_state, URLEncoder.encode(redirect_uri));
	...
	public static String fetchAccessToken(String code) {
		...
		String param = String.format(
				"code=%s&grant_type=%s&client_id=%s&client_secret=%s", code,
				"code", client_key, client_secret);
		logger.info(String.format("req_data is : %s", param));
		String res_data = post_request(String.format("%s%s", oauth_host, url),
				param);
	...
	public static List<Map<String, Object>> listProjects() {
		...
		String req_url = String.format("%s%s?access_token=%s", api_host, url,
				access_token);
	...
	public static List<String> listWebhookEvent4Projects() {
		...
		try {
			ObjectMapper mapper = new ObjectMapper();
			return (List<String>) mapper.readValue(res_data, Map.class).get(
					"events");
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public static List<String> listWebhookEvent4Organizations() {
		...
		String res_data = get_request(String.format("%s%s?access_token=%s",
				api_host, url, access_token));
		logger.info(String.format("res_data is : %s", res_data));
		try {
			ObjectMapper mapper = new ObjectMapper();
			return (List<String>) mapper.readValue(res_data, Map.class).get(
	 ...
	 * @return
	 */
	public static String createWebhook4Project(String p_id, String callbackURL,
			List<String> events) {
		String url = "/api/projects/%s/hooks";
		String req_url = String.format("%s" + url + "?access_token=%s",
				api_host, p_id, access_token);
	 ...
	 * @return
	 */
	public static String createWebhook4Organization(String p_id,
			String callbackURL, List<String> events) {
	 ...
	 * @return
	 */
	public static String updateWebhook4Project(String p_id, String hook_id,
			String callbackURL, List<String> events) {
		String url = "/api/projects/%s/hooks/%s";
		String req_url = String.format("%s" + url + "?access_token=%s",
				api_host, p_id, hook_id, access_token);
	 ...
	 * @return
	 */
	public static String updateWebhook4Organization(String p_id,
			String callbackURL, List<String> events) {
		String url = "/api/organizations/%s/hooks/";
		String req_url = String.format("%s" + url + "?access_token=%s",
				api_host, p_id, access_token);
	...
	public static String listWebhook4Organizations(String _id) {
		String url = "/api/organizations/%s/hooks/";
		String res_data = get_request(String.format("%s" + url
				+ "%s?access_token=%s", api_host, _id, access_token));
		logger.info(String.format("res_data is : %s", res_data));
		return res_data;
	}
	 ...
	 * @return
	 */
	private static String check_access_token_request(String req_url,
	 ...
	 * @return
	 */
	private static String post_request(String req_url,
		...
		try {
			...
			StringEntity entity = new StringEntity(
					new ObjectMapper().writeValueAsString(params), contentType);
			httpPost.setEntity(entity);
			CloseableHttpResponse response = httpclient.execute(httpPost);
