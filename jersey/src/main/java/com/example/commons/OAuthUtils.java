...
//			process the authorization response and parse the authorization code;
...
//			using credential access protected resources;expired access tokens are automatically refreshed using the refresh token
